        ...
        <div className="privacy-policy">
            <div className="privacy-policy-container">
                ...
                <div className="policy-info">
                    <p><strong>Effective Date:</strong> 03/17/2025</p>
                    <p><strong>Notice Version:</strong> 1.0</p>
                </div>

                <div className="contact-info">
                    <h2>Data Controller Contact Information</h2>
                    <p>Sham Superstore</p>
                    <p>support@shamsuperstore.com</p>
                </div>

                <div className="intro">
                    <p>This document governs the privacy notice of our website www.shamsuperstore.com</p>
                ...
                <section className="your-rights">
                    <h2>Your Rights</h2>
                    <p>When using our website and submitting personal data to us, you may have certain rights under the General Data Protection Regulation (GDPR) and other laws. Depending on the legal basis for processing your personal data, you may have some or all the following rights:</p>
                    ...
                    <p>For details about your rights under the law, visit <a href="https://goo.gl/F41vAV" target="_blank" rel="noopener noreferrer">https://goo.gl/F41vAV</a></p>
                </section>

                <section className="definitions">
                    <h2>Definitions</h2>
                    <p><strong>'Non-personal data' (NPD)</strong> is information that is in no way personally identifiable.</p>
                    ...
                    <p>A <strong>"visitor"</strong> is someone who merely browses our website. A <strong>"member"</strong> is someone who has registered with us to use or buy our services and products. The term <strong>"user"</strong> is a collective identifier that refers to either a visitor or a member.</p>
                </section>

                <section className="topics-covered">
                    <h2>Topics Covered in Our Privacy notice</h2>
                    <ul>
                ...
                <section className="information-we-collect">
                    ...
                    <h3>Our Legal Basis for Collecting and Processing Personal Data</h3>
                    ...
                    <p>If you use our mobile application, you may have to provide PD to use it.</p>

                    <h4>Collecting Your Location Information</h4>
                    <p>When you use our services, we may collect and process information about your actual physical location. We use several technologies, like GPS and IP tracking, to determine your location. These technologies may also provide us with information about nearby cell towers, Wi-Fi access points, and other devices.</p>

                    <h4>Website Chat Software or Contact Forms</h4>
                ...
                <section className="use-of-cookies">
                    ...
                    <h3>We may also use cookies for:</h3>
                    <ul>
                ...
                <section className="how-information-used">
                    ...
                    <p>When we communicate with you about our website, we will use the email address you provided when you registered as a member or user. We may also send you emails with promotional information about our website or offers from us or our affiliates unless you have opted out of receiving such information. You can change your contact preferences at any time through your account or by sending us an email with your request to: support@shamsuperstore.com</p>
                    ...
                    <h3>Community Discussion Boards</h3>
                ...
                <section className="retaining-destroying">
                ...
                <section className="do-not-track">
                ...
                <section className="links-other-websites">
                ...
                <section className="protecting-children">
                ...
                <section className="email-policy">
                ...
                <section className="credit-card-use">
                ...
                <div className="copyright">
                    <p>Copyright © Orion Systems. This document or any portion of it may not be copied or duplicated without a license from <a href="http://www.DisclaimerTemplate.com" target="_blank" rel="noopener noreferrer">http://www.DisclaimerTemplate.com</a></p>
                </div>
            </div>
        </div>
    );
