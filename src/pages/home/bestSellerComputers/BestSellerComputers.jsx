...
import './BestSellerComputers.scss';

const BestSellerComputers = () => {
    const products = [
        {
            id: 1,
    ...
    return (
        <div className="best-sellers-section">
            <h2 className="section-title">Best Sellers in Computers and electronics</h2>
...
export default BestSellerComputers;